	 ...
	 if(isset($_SESSION["type"]))
{
	...
	{
		?>
     <p><a href="examview.php?first=<?php if(isset($first)) { echo $first; } else { echo ""; } ?>&amp;last=<?php if(isset($last)) { echo $last; } else { echo ""; } ?>"><a href="exam.php" ><strong>Add Examination Records</strong></a></p>
 <?php
	}}
	?>
  </section>
