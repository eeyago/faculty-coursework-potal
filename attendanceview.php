...
?>
	...
	else if($first >= mysql_num_rows($result))
	{ ?>
    <a href="attendanceview.php?first=<?php echo $first; ?>&last=<?php echo $last; ?>">
    <?php
	}
...
?>
 <?php
	...
	{
		?>
     <p><a href="examview.php?first=<?php if(isset($first)) { echo $first; } else { echo ""; } ?>&amp;last=<?php if(isset($last)) { echo $last; } else { echo ""; } ?>"><a href="attendance.php" ><strong>Add Attendance Records</strong></a></p>
 <?php
	}
	}
	?>
