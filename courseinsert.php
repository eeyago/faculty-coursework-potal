...
<form name="form1" method="post" action="" id="formID">
  ...
  <p>
    ...
    <input type="text" name="coursename" id="textfield2" class="validate[required,custom[onlyLetterSp]] text-input" value="<?php if(isset($coursename)) { echo $coursename; } else { echo ""; } ?>">
  </p>
  <p>
  ...
  <p>
    ...
    <input type="text" name="coursekey" id="coursekey" class="validate[required,custom[onlyLetterSp]] text-input" value="<?php  if(isset($coursekey)) { echo $coursekey; } else { echo ""; }  ?>">
  </p>
  <p>
