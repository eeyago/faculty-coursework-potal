...
<form name="form1" method="post" action="" id="formID">
  ...
  <p>
    ...
    <input type="text" name="adminname" id="adminname"  class="validate[required,custom[onlyLetterSp]] text-input"  value="<?php if(isset($adminname)) { echo $adminname; } ?>">
</p>
<p>
 ...
 <p>
  ...
  <p>
    ...
    <textarea name="address" id="address" class="validate[required] text-input" cols="45" rows="5"  ><?php if(isset($address)) { echo $address; } ?></textarea>
</p>
  <p>
    <label for="contactno">Contact No</label>
    <input type="text" name="contactno" id="contactno"  class="validate[required,custom[phone]] text-input" value="<?php if(isset($contact)) { echo $contact; } ?>">
</p>
  <p>
