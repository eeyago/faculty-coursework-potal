...
{
mysql_query("UPDATE subject SET subname='$_POST[subname]', 	comment='$_POST[comment]', 	courseid='$_POST[course]', 	subtype='$_POST[subtype]', 	semester='$_POST[semester]', 	lecid='$_POST[semester2]' WHERE subid = '$_POST[subid]'");
...
<form name="form1" method="post" action="" id="formID">
  ...
  <p>
    ...
    <input type="text" name="subname" id="textfield2" class="validate[required,custom[onlyLetterSp]] text-input" value="<?php if(isset($subname)) { echo $subname; } else { echo ""; }?>">
  </p>
  <p>
    <label for="textarea">Comment</label>
    <textarea name="comment" id="textarea" class="validate[required]" cols="25" rows="5"><?php if(isset($comment)) { echo $comment; } else { echo ""; } ?></textarea>
  </p>
 <p>
