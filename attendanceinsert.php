...
if(isset($_POST['button2']) && isset($_POST["totclass"]))
	{
		echo "Inserting";
		  $stuid=$_POST['stuid'];
    $attclass =$_POST['attclass'];
...
<table width="964" border="1">
  ...
  <tr>
    <td>Semester: <?php echo $_POST["semester"]; ?> Semester</td>
    <td>Total Students : <input name="tstudents" value="<?php echo $tstudent; ?>" readonly="readonly"/></td>
  </tr>
  <tr>
...
<form id="form1" name="form1" method="post" action="">
  ...
  <input name="subid" type="hidden" size="10" value="<?php if(isset($_POST['subject'])) { echo $_POST['subject']; } else { echo ""; } ?>"/>
  	<input name="subid" type="hidden" size="10" value="<?php if(isset($_POST['subject'])) { echo $_POST['subject']; } else { echo ""; } ?>"/>
    	
  
        <input name="attid" type="hidden" size="10" value="<?php if(isset($_GET['slid'])) { echo $_GET['slid']; } else { echo ""; } ?>"/>
 <?php
 
 if(isset($restotstrec))
 {
...
{
	?>
    <input name="totclass" type="hidden" size="10" value="<?php if(isset($_POST['totalclass'])) { echo $_POST['totalclass']; } ?>"/>
