...
<article class="post">
 ...
 ?>
 <a href='<?php echo "adminview.php?slid=$row[adminid]&view=delete"; ?>'><img src='images/delete.png' width='32' height='32' onclick="return confirm('Are you sure??')" /></a> </td>
<?php
echo "</tr>&nbsp;";
	$i++;
  }
...
$last= $_GET['last']- 10;
  ...
  <tr>
    ...
    <a href="adminview.php?first=<?php if(isset($first)) { echo $first; } ?>&last=<?php if(isset($last)) { echo $last; } ?>">
